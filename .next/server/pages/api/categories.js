...
async function handler(req, res) {
    const categories = await _models_db__WEBPACK_IMPORTED_MODULE_1__/* .Category.find */ .WD.find({}).populate("product");
    res.json({
        message: "success",
        data: categories
    });
...
var __webpack_exports__ = __webpack_require__.X(0, [675], () => (__webpack_exec__(7171)));
