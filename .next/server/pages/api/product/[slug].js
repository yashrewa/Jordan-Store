...
async function handler(req, res) {
    ...
    const product = await _models_db__WEBPACK_IMPORTED_MODULE_1__/* .Product.findById */ .xs.findById(slug);
    console.log(product);
    res.json({
        message: "hello",
        data: product
...
var __webpack_exports__ = __webpack_require__.X(0, [675], () => (__webpack_exec__(1164)));
